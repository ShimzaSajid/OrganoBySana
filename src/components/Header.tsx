...
export default function Header() {
 ...
 useEffect(() => {
  ...
  // Add this: Prevent body scroll when mobile menu is open
  if (mobileOpen) {
  ...
  return () => {
    ...
    document.body.style.overflow = 'unset'; // Add this
  };
}, [mobileOpen]); 

  return (
    <nav id="navbar" className="bg-brand-green text-brand-beige py-6 px-6 fixed w-full top-0 z-50 transition-all duration-300">
      ...
      <div className="border-b border-brand-beige/10 pb-4">
        ...
        <div className="pl-4 space-y-3 mt-2">
          <Link 
            ...
            className="flex items-center justify-between text-white/80 hover:text-brand-gold transition duration-300 py-2"
            onClick={closeMenu}
          >
            Hair Care
