...
export const PRODUCTS: CatalogItem[] = [
  // ==================== HAIR CARE ====================
  {
    ...
    gallery: [
      { src: "/images/ChatGPT Image Oct 4, 2025, 12_18_25 AM.png", alt: "Signature Hair Oil bottle" },
      { src: "/images/7 Benefits of Amla for Hair.png", alt: "Amla benefits" },
      { src: "/images/Slim_Tox_AI.png", alt: "Lifestyle image" },
      { src: "/images/hair-oil-3.jpg", alt: "Bottle angled" },
    ],
    benefits: [
